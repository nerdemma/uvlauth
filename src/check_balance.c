...
const char *hex_sig = generar_cadena("Aleph Hackathon 2026\0");
...
"{\"jsonrpc\":\"2.0\",\"method\":\"eth_getBalance\",\"params\":[\"0x8db97C7cEcE249c2b98bDC0226Cc4C2A57BF52FC\", \"latest\"],\"id\":1}"); //direccion de prueba
